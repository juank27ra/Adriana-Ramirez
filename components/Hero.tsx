...
import OfficeModal from "./OficceModal";
            ...
            <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
              ...
              <div className="space-y-3 sm:space-y-4">
                <p className="text-base sm:text-lg text-foreground/90 leading-relaxed">
                  Brindamos acompañamiento profesional para ayudarte a
                  comprender, gestionar y fortalecer tu bienestar emocional,
                  personal o familiar y organizacional.
                  <br />
                  <br />
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
                ...
                <button
                  ...
                  className="group border-2 border-primary text-primary px-5 sm:px-6 py-3 sm:py-4 rounded-lg hover:bg-primary hover:text-primary-foreground transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="group border-2 border-primary/50 text-primary/80 px-5 sm:px-6 py-3 sm:py-4 rounded-lg hover:border-primary hover:text-primary transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2"
                >
